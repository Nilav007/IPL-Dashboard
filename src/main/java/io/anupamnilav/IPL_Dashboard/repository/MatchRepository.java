...
public interface MatchRepository extends CrudRepository<Match, Long> {
    ...
    List<Match> getMatchesByTeamBetweenDates(@Param("teamName")String teamName, LocalDate startDate, LocalDate endDate);*/
    default List<Match> findLatestMatchesByTeam1OrderByDateDesc(String teamName, int count) {
